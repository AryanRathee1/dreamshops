...
import com.aryan.dreamshops.service.order.IOrderService;
...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse> getOrderById(@PathVariable Long orderId) {
        try {
            ...
            return ResponseEntity.ok(new ApiResponse("Order with order id : "+orderId, order));
    ...
    public ResponseEntity<ApiResponse> getUserOrders(@PathVariable Long userId) {
        try {
            ...
            return ResponseEntity.ok(new ApiResponse("All orders of user with user id : "+userId, orders));
        } catch (ResourceNotFoundException e) {
            return  ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ApiResponse("Oops!", e.getMessage()));
        }
    }
